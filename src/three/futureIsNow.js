...
import { vertexShader, fragmentShader } from './futureIsNowShader';
import { FontLoader } from 'three/addons/loaders/FontLoader.js';
export default function futureIsNow() {
    const preload = () => {
          ...
          if (intersects.length > 0) {
            ...
            for (var i = 0, l = pos.count; i < l; i++) {
              ...
              if (this.buttom) {
                ...
                this.colorChange.setHSL(0.9 + zigzagTime, 1.0, 0.5);
                coulors.setXYZ(i, this.colorChange.r, this.colorChange.g, this.colorChange.b);
                coulors.needsUpdate = true;
                ...
                if (
                  ...
                  this.colorChange.setHSL(0.9, 1.0, 0.7);
                  coulors.setXYZ(
                    i,
                    this.colorChange.r,
                    this.colorChange.g,
